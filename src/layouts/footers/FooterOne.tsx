...
import footer_logo from "@/assets/logos/logo-2.png";
...
const footer_data: DataType = {
  email: `Enquire@astiacademy.ac.ae`,
  phone: `+97142809955`,
  location: `ASTI Academy, Building 29, 5th Street, Al-Qusais-2, Dubai.`,
  footer_info: `ASTI combines science, creativity, and critical thinking to drive innovation and fuel your path towards excellence.`,
  links: [
    { title: `HOME`, link: "/" },
    { title: `ABOUT`, link: "/about" },
    { title: `SERVICES`, link: "/service" },
    { title: `PROGRAMS`, link: "/portfolio" },
          ...
          <div className="row">
            ...
            <div className="col-lg-6 offset-lg-1">
              ...
              <ul className="cs_footer_contact_list cs_mp0">
                <li>
                  <h6 className="text-white m-0 pb-2">Quick Links</h6>
                  <Link href="/about">About ASTI</Link>
                  <br />

                  <Link href="/labs">Our Labs</Link>
                  <br />
                ...
                <li>
                  <h6 className="text-white m-0 pb-2">Get in Touch</h6>
                ...
                <li>
                  <h6 className="text-white m-0 pb-2">People Also Ask</h6>
                  <Link href="/why-choose">Why Choose</Link>
                  <br />
                  <Link href="/accreditations">Accreditations</Link>
                  <br />
                  <Link href="/fees-scholarships">Fees & Scholarships</Link>
                  <br />
                  <Link href="/professional-programs">
